...
let
  sources = {
    ...
    "electron-to-chromium-1.3.238" = {
      ...
      version = "1.3.238";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.3.238.tgz";
        sha512 = "k+s6EIiSTgfOm7WiMlGBMMMtBQXSui8OfLN1sXU3RohJOuLGVq0lVm7hXyDIDBcbPM0MeZabAdIPQOSEZT3ZLg==";
      };
    };
    "elliptic-6.5.0" = {
      name = "elliptic";
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."elm-verify-examples-4.0.1" // {
        dependencies = [
          sources."chalk-2.4.2"
